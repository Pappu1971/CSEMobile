...
public class OnlineCourses extends AppCompatActivity {
    ...
    private OnlineCoursesAdapter mSectionsPagerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Online Help");
        ...
        mSectionsPagerAdapter = new OnlineCoursesAdapter(getSupportFragmentManager());
